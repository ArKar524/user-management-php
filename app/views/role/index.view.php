...
<body class="flex min-h-screen bg-gray-100">
    ...
    <div class="flex-1 flex flex-col  ">
        ...
        <div class="lg:mt-10 mt-16 px-8 flex justify-between">
            ...
            <?php if (checkPermission('Role', 'create')): ?>
            <div class="p-2 text-xl bg-indigo-400 rounded">
                <a href="<?php echo ROOT; ?>url=role/create">Create</a>
            </div>
            <?php endif; ?>
        </div>
        <!-- Page Content -->
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b
                        ...
                        <!-- <td class="px-6 py-4">
                            ...
                            <span><?php echo $permission->feature_name ?></span>

                            <?php endforeach; ?>
                        </td> -->

                        <td class="px-6 py-4">
                            <?php if (checkPermission('Role', 'update')): ?>
                            <a href="<?php echo ROOT; ?>url=role/edit/<?php echo $role->id; ?>"
                                class="font-medium me-2 text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                            <?php endif; ?>
                            <?php if (checkPermission('Role', 'delete')): ?>
                            <a href="<?php echo ROOT; ?>url=role/delete/<?php echo $role->id; ?>"
